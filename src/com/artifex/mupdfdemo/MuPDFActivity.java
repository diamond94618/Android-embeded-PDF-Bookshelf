...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport
{
	...
	private final static String xiaolong="ww2Z7hmA1LE=cGlzNjE4";
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if (core == null) {
			...
			if (true) {
				...
				if(currentBookNo !=-1){
					bookFileName = pdfFileNames[currentBookNo];
					CurrentBook_curPage = "currentPage"+bookFileName;
				}
				
				//intent.putExtra("BOOK_TYPE", bookFileName);
				//intent.putExtra("BOOK_INDEX", position);
				
				//bookType = getIntent().getIntExtra("BOOK_TYPE", -1);
				//bookIndex = getIntent().getIntExtra("BOOK_INDEX", -1);
				...
				if (currentBookNo != -1) {
					...
					try {
						...
						InputStream is = assetManager.open(bookFileName);
	...
	public void createUI(Bundle savedInstanceState) {
		...
		*/
		...
		mDocView.setDisplayedViewIndex(prefs.getInt(CurrentBook_curPage, 0));
	...
	public void OnCreateBookBtnClick(){
		...
		public void onClick(DialogInterface dialog, int whichButton) {
			...
			insertBookMark(currentBookNo, bookmarkStr, page);
		  }
		});
	...
	public void insertBookMark(int bookNo, String text, int page){
	    ...
	    db.addBook(new Book(bookNo, text, page));       
	...
	public void OnSelectBookBtnClick(){
		...
		intent.putExtra("BOOK_NO", currentBookNo);
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		if (mDocView != null) {	
			...
			edit.putInt(CurrentBook_curPage, mDocView.getDisplayedViewIndex());
			edit.commit();
		}
